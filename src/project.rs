...
pub fn configure_imported_functions() -> Vec<(crate::ast::Path, Vec<Type>, Type)> {
    let mut externs: Vec<(crate::ast::Path, Vec<Type>, Type)> = vec![
        (
            vec!["project", "std", "io", "write"].into(),
            vec![Type::StringLiteral],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "readi64"].into(),
            vec![],
            Type::I64,
        ),
        (
            vec!["project", "std", "io", "writeu8"].into(),
            vec![Type::U8],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writeu8ln"].into(),
            vec![Type::U8],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writeu16"].into(),
            vec![Type::U16],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writeu16ln"].into(),
            vec![Type::U16],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writeu32"].into(),
            vec![Type::U32],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writeu32ln"].into(),
            vec![Type::U32],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writeu64"].into(),
            vec![Type::U64],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writeu64ln"].into(),
            vec![Type::U64],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writei64"].into(),
            vec![Type::I64],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writei64ln"].into(),
            vec![Type::I64],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writei32"].into(),
            vec![Type::I32],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writei32ln"].into(),
            vec![Type::I32],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writei16"].into(),
            vec![Type::I16],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writei16ln"].into(),
            vec![Type::I16],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writei8"].into(),
            vec![Type::I8],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writei8ln"].into(),
            vec![Type::I8],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writebool"].into(),
            vec![Type::Bool],
            Type::Unit,
        ),
        (
            vec!["project", "std", "io", "writeboolln"].into(),
            vec![Type::Bool],
            Type::Unit,
        ),
    ];
