...
run() {
    ...
    if [[ "$OSTYPE" == "linux-gnu"* ]]; then
        nasm -g -f elf64 ./std/io.asm -l ./target/std_io.lst -o ./target/std_io.obj > assembler.log
        ...
        nasm -g -f macho64 ./std/io.asm -l ./target/std_io.lst -o ./target/std_io.obj > assembler.log
